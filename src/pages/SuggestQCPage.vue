  ...
  <q-page class="flex-center qpage bg-image text-accent">
    ...
    <div class="text-center text-h6 flex-center">
      ...
      <div class="text-info bg-secondary text-subtitle1 feed-card">
        Rewards for QuickConnect suggestions will be rewarded to the first user
...
import qcAction from "/src/actions/quickConnect.js";
...
export default defineComponent({
  ...
  setup() {
    ...
    const submitQuestion = async () => {
      await qcAction
        .saveQCSuggestion(user.UserID, suggestion.value)
        .then(() => {
