      ...
      <div class="q-pa-md items-start flex-center">
        <q-card class="q-mt-md feed-card transparent" flat>
          ...
          <q-card-section>
            ...
            <q-item>
              <q-btn
                class="absolute-center text-weight-bolder"
                size="lg"
                color="accent"
                glossy
                rounded
        ...
        <q-infinite-scroll @load="getMore" v-if="filterType === 'book'">
          ...
          >
            <div class="topOfBook">
              <p class="text-h5 text-center text-accent">
                {{ book.BookTitle }}
              </p>
            </div>

            <div class="bottomOfBook">
              <p class="text-subtitle1 text-center text-accent">
            ...
            <q-dialog v-model="bookDialog" full-width>
              <q-card>
                <q-toolbar>
                  ...
                  <q-toolbar-title
                    ><span class="text-weight-bold">{{ openBookTitle }} </span>
                    <span class="q-ma-sm"
                      ><q-btn
                        flat
                        icon="mdi-pencil"
                      ...
                      ></q-btn
                    ></span>
                    - {{ openBookUserDisplayName }}</q-toolbar-title
                  >
                ...
                <q-dialog v-model="editBookTitleDialog" persistent>
                  <q-card style="min-width: 350px">
                    ...
                    <!-- <q-card-actions align="right" class="text-primary">
                      ...
                      <q-btn flat label="Edit Title" @click="editBook()" />
                    </q-card-actions> -->
                  </q-card>
                </q-dialog>
                ...
                <q-card-section class="q-mt-xl">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <p class="text-h5" text-info>Table of Contents</p>
                  ...
                  <q-card>
                    <q-card-section class="row items-center">
                      ...
                      <span class="q-ml-sm"
                        ...
                        {{ book.BookTitle }} permanently?</span
                      >
                    </q-card-section>
                ...
                <q-card-actions>
                  <q-btn
                    ...
                    v-if="openBookOwnerID === user.UserID"
                  ></q-btn>
                </q-card-actions>
              </q-card>
            </q-dialog>
      ...
      >
        <q-card width="80%">
          ...
          <q-card-section>
            ...
            <div>
              <q-btn-group spread>
                <q-btn color="accent" label="Memory" @click="setStoryType(1)" />
                <q-btn color="accent" label="Recipe" @click="setStoryType(3)" />
                <q-btn
                  color="accent"
                  label="Interview"
          ...
          <q-card-section class="q-pt-none">
            ...
            <div v-if="storyTypeID === 3">Ingredients:</div>
            <q-item v-if="storyTypeID === 3">
              <q-editor
            ...
            <div v-if="storyTypeID === 3">Directions:</div>
            <q-item v-if="storyTypeID === 3">
              <q-editor
                v-model="storyText"
                :dense="$q.screen.lt.md"
            ...
            <div v-if="storyTypeID !== 3">Memory text:</div>
            <q-item v-if="storyTypeID !== 3">
              <q-editor
                v-model="storyText"
                :dense="$q.screen.lt.md"
...
export default defineComponent({
  ...
  setup() {
    ...
    const openBookOwnerID = ref(null);
    const openBookID = ref(null);
    const openBookTitle = ref(null);
    const openBookUserDisplayName = ref(null);
    ...
    const oldBookTitle = ref(openBookTitle.value);
    const startStyleList = ref("flat q-ma-md book-card bookLook text-center");
    ...
    const setFilter = async (newfilter) => {
      console.log("running setFilter, filter is: ", filter.value);
    ...
    const closeBookDialog = async () => {
      console.log("about to run setFilter for: ", filter.value);
      setFilter(filter.value);
      bookDialog.value = false;
      openBookID.value = null;
      openBookOwnerID.value = null;
      openBookTitle.value = null;
      openBookUserDisplayName.value = null;
