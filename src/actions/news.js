...
export default {
  async getNews(userID, subType) {
    let myroute = servername + "/getnews";
    const params = {
      userID: userID,
      subType: subType,
      token: token,
  ...
  async getNewsUnread(userID, subType) {
    let myroute = servername + "/getnewsunread";
    const params = {
      userID: userID,
      subType: subType,
      token: token,
  ...
  async markRead(userID, newsID) {
    let myroute = servername + "/markread";
    const params = {
      userID: userID,
      newsID: newsID,
      token: token,
